...
---------------------------- Modification Log  10/19/2018 ---------------------------------------------------
-- 1. Inserted First and Last Name options int o artist table, and dropped artist_name
-- 2. Inserted and corrected release date data in loan-status table
-- 3. Inserted data into artist_type table to give solo and group functionality
-- 4. New Qeury additions are located on line 468 for this project
---------------------------------------------------------------------------------------
...
CREATE TABLE artist
	...
	artist_fname	VARCHAR(50) NOT NULL,					-- Added First Name column --
	artist_lname	VARCHAR(50) NOT NULL);					-- Added Last Name column --
...
SELECT inv_name AS 'Disk Name', artist_fname AS 'Artist First Name', artist_lname AS 'Artist Last Name'
FROM  artist
